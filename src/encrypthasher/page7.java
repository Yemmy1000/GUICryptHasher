...
//        setExtendedState(MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jbtDecryptAES256 = new javax.swing.JButton();
        ...
        jbtDecryptAES256.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jbtDecryptAES256.setText("Decrypt");
        jbtDecryptAES256.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtDecryptAES256ActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("AES-256 ALGORITHM");
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                            .add(jScrollPane2)
                                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                                .add(jbtDecryptAES256, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .add(338, 338, 338))))
                                    .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(jbtDecryptAES256, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jScrollPane2))
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(jbtAES256, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 37, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel1Layout.linkSize(new java.awt.Component[] {jbtAES256, jbtDecryptAES256}, org.jdesktop.layout.GroupLayout.VERTICAL);
    ...
    public void mdAES256(String plain_text){
...
//                long cpuBefore = osMBean.getProcessCpuTime();
    ...
    private void jbtDecryptAES256ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtDecryptAES256ActionPerformed
//        long startTime = System.nanoTime();
        jtpBlowfishPlainText1.setText("");
        myKey =  encKey.getText();
...
//            jtxtDecTimeBlowfish.setText(dc.format(gg));
              long endTime = System.nanoTime();                  
              System.out.println("AES-256 DEcryption execution time: " + (endTime - startTime) + " nanosecond");
        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(page7.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NoSuchPaddingException ex) {
            Logger.getLogger(page7.class.getName()).log(Level.SEVERE, null, ex);
    ...
    }//GEN-LAST:event_jbtDecryptAES256ActionPerformed
...
//        fileTextLength.setText(fileText.length()+"");
    ...
    private javax.swing.JButton jbtDecryptAES256;
